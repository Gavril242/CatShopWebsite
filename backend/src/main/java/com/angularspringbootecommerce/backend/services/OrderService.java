...
public class OrderService {
    ...
    public List<OrderDto> getAllOrders(Authentication authentication) {
        // For security, you might want to ensure the authenticated user is an admin before proceeding.
        // This depends on how you've set up your roles in your application.
        // For example:
